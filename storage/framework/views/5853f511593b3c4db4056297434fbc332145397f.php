  ...
  <div class="limiter">
    ...
    <h4><b>Results</b>
     <div class="searchForm">
      <form action="<?php echo e(route('teacher-paper_result')); ?>" method="get">
...
<script type="text/javascript">
  $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('teacher-paper_result_page',['id'=>':id','s'=>':year','page'=>':page'])); ?>";
   ...
   $(document).on('click', '#show-button', function() {
    ...
    loading.style.display='';
    var id=$(this).data('id');
    var img ="<?php echo e(route('teacher-resultshow',['id'=>':id'])); ?>";
 ...
 $('#delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('teacher-delete_result')); ?>',
    data: {
