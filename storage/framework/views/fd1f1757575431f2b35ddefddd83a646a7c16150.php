...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  ...
  <div class="limiter">
    ...
    <div class="searchForm">
     <form action="<?php echo e(route('admin-recycle_normal_paper')); ?>" method="get">
...
<script type="text/javascript">
   $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('admin-recycle_normal_paper_page',['s'=>':year','page'=>':page'])); ?>";
 ...
 $('#delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('admin-recycle_normal_paper_submit')); ?>',
    data: {
 ...
 $('#p_delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('admin-p_delete_normal_paper_submit')); ?>',
    data: {
      '_token': $('input[name=_token]').val(),
      'id': $('#p_delete-id').text(),
    },
