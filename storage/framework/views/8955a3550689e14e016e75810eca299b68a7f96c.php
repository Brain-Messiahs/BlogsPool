...
<script type="text/javascript">
	...
	var end = $('#end').val();
	if(start!=''&&end!=''){
   	var img ="<?php echo e(route('admin-balance_sheet_load',['type'=>':page','start'=>':start','end'=>':end'])); ?>";
...
$('input[type="radio"]').on('change', function(e) {
   if($(this).val()=='all'){
   	$('#date_div').hide();
   	var img ="<?php echo e(route('admin-balance_sheet_load',['type'=>':page'])); ?>";
...
if(val=='all'){
	var img ="<?php echo e(route('admin-export_balance_sheet',['type'=>':page'])); ?>";
    var img = img.replace('%3Apage','all');
  ...
  var end = $('#end').val();
  if(start!=''&&end!=''){
   	var img ="<?php echo e(route('admin-export_balance_sheet',['type'=>':page','start'=>':start','end'=>':end'])); ?>";
    var img = img.replace('%3Apage','date');
