...
<h5 id="noti1"></h5>
  ...
  <div class="modal-footer">
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('<?php echo e(asset('wp-content/image/beer-background.jpg')); ?>');">
            <div  class="wrap-login100 p-t-15 p-l-8">
                 <img src="<?php echo e(asset('admin_css/images/logo.png')); ?>" width="95%">
...
<?php endif; ?>        
                <form autocomplete="off" method="POST" action="<?php echo e(route('author-login')); ?>" class="login100-form validate-form p-b-33 p-t-5">
                        <?php echo csrf_field(); ?>
