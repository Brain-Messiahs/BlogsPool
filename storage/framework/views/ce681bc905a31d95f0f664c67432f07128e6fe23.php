...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  ...
  <div class="limiter">
    ...
    <div class="searchForm">
     <form action="<?php echo e(route('teacher-recycle_advanced_paper')); ?>" method="get">
...
<script type="text/javascript">
   $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('teacher-recycle_advanced_paper_page',['s'=>':year','page'=>':page'])); ?>";
 ...
 $('#delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('teacher-recycle_advanced_paper_submit')); ?>',
    data: {
