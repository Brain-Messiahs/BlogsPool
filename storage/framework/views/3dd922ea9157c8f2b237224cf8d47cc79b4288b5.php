...
<div id="content" class="pmd-content content-area dashboard" style="padding-bottom: 5px">
    <div class="container-fluid full-width-container">
        ...
        <div class="section"> 
            ...
            <form method="post" action="<?php echo e(route('admin-edit_profile_submit')); ?>">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                ...
                                <input type="text" name="contact" id="contact" class="form-control" value="<?php echo e(Auth::user()->contact); ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                ...
                                <input type="email" name="email" id="email" class="form-control" value="<?php echo e(Auth::user()->email); ?>" required>
                            </div>
                        </div>
                    </div>
