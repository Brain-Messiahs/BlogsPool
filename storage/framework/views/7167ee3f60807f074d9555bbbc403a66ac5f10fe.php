...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/mainadv_ans_upload.css')); ?>">
  <div class="limiter">
    <div  class="title">
    <div class="searchBox">
                    ...
                    <?php endif; ?>
                     ...
                     <td class="column1"><?php echo e($no++); ?></td>
                        <td class="column2"><?php echo e($user->qid); ?></td>
                                    ...
                                    <td class="column7"><button type='submit' class="btn btn-warning" id='<?php echo e($user->qpqtypeid); ?>'>OK</button></td></tr>
                                  </tr>
                    <?php endif; ?>
