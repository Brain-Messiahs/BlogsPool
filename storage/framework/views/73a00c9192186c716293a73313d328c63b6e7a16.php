...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/mainteacher_recycle.css')); ?>">
  <div class="limiter">
    <div  class="title">
                <div class="searchBox">
                  <h4><b>Deleted Teachers</b>
    <div class="searchForm">
       <form action="<?php echo e(route('admin-recycle_teacher')); ?>" method="get">
...
<script type="text/javascript">
  $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('admin-recycle_teacher_page',['s'=>':year','page'=>':page'])); ?>";
 ...
 $('#delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('admin-recycle_teacher_submit')); ?>',
    data: {
