...
<style type="text/css"> html{margin:32px;padding:32px} </style>
<h2 style="text-decoration: underline;text-align: center;font:bold;font-size: 25px">Accounting List</h2>
...
<?php endif; ?>
  ...
  <tbody>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
     <?php if(app('request')->input('id')=="all"): ?>
    <tr class="btn-danger"><td colspan="6">Total Remain Balance</td><td><?php echo e($ins); ?></td><td><?php echo e($vrs); ?></td><td><?php echo e($Sahu); ?></td><td><?php echo e($Custom1); ?></td><td><?php echo e($Custom2); ?></td><td><?php echo e($cash); ?></td></tr>
    <?php else: ?>
    <tr class="btn-danger"><td colspan="6">Total Remain Balance</td> <?php if(app('request')->input('id')=="Inspire's A/c"): ?><td><?php echo e($ins); ?></td> <?php elseif(app('request')->input('id')=="Varsha's A/c"): ?><td><?php echo e($vrs); ?></td><?php elseif(app('request')->input('id')=="Sahu's A/c"): ?><td><?php echo e($Sahu); ?></td> <?php elseif(app('request')->input('id')=="Custom1's A/c"): ?><td><?php echo e($Custom1); ?></td> <?php elseif(app('request')->input('id')=="Custom2's A/c"): ?><td><?php echo e($Custom2); ?></td> <?php elseif(app('request')->input('id')=="Cash"): ?><td><?php echo e($cash); ?></td><?php endif; ?></tr>
    <?php endif; ?>
  </tbody>
</table>