        ...
        <div class="container-login100" style="background-image: url('<?php echo e(asset('img/inspire.jpg')); ?>');">
            <div  class="wrap-login100 p-t-30">
               <img src="<?php echo e(asset('img/logo.png')); ?>" width="99%">
                <span class="login100-form-title p-b-41" style="font-family: Ubuntu-Bold;color: rgba(10, 10, 10, 0.8);">
                    Accounting Login
                </span>
              <?php if($errors->any()): ?>
...
<?php endif; ?>         <form autocomplete="off" method="POST" action="<?php echo e(route('account-login')); ?>" class="login100-form validate-form p-b-33 p-t-5">
                        <?php echo csrf_field(); ?>
           ...
           <div class="col-md-12" style="min-height: 5vh; max-height: 5vh;padding-top: 6px;background-color: rgba(43, 43, 51, 0.9);">
                      <p style=" color: #fff" class="text-center">© 2019 Inspire Academy. | Designed by  <a style=" color: #fff"  href="https://deltatrek.in" target="_blank">Delta Trek</a> </p>
                    </div>  
    </div>
