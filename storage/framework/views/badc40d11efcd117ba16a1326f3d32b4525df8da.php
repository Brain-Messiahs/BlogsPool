...
<form action="<?php echo e(route('admin-normal_paper_ques_upload_submit')); ?>" method="POST" enctype="multipart/form-data">
...
<form action="<?php echo e(route('admin-normal_paper_sol_upload_submit')); ?>" method="POST" enctype="multipart/form-data">
  <?php echo e(csrf_field()); ?>
