...
<?php endif; ?>
        <form class="form-group" method="POST" action="<?php echo e(route('admin-uploaded_paper_edit_submit')); ?>">
...
<div>
  ...
  <input style="display: none;" type="radio" name="radio1" id="radio1" value="" checked="true"></input>
