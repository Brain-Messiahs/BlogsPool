...
<body>
    <div id="all">
                ...
                <div class="navbar navbar-default yamm" role="navigation" id="navbar">
                    <div class="container">
                        <div class="navbar-header">
                            <a class="navbar-brand home"><img src="<?php echo e(asset('student/images/logo.png')); ?>" alt="inspirekolhapur logo" class="img-responsive"> </a>
                        </div>
                            ...
                            <div class="navbar-collapse">
                                <ul class="nav navbar-nav pull-right exam-paper ">
                                    <li class="user-profile">
                                        <table>
                                            <tr>
                                                <td style="padding: 0% 20px 16px 0%;"><img  src="<?php echo e(asset('student/images/'.Auth::user()->photo)); ?>" height="50"></td>
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td style="padding: 5px 5px;">Candidate Name</td>
                                                            <td> : <span style="color: #f7931e; font-weight: bold"><?php echo e(Auth::user()->name); ?></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 5px 5px;">Subject Name</td>
                                                            <td> : <span style="color: #f7931e; font-weight: bold"><?php echo e($pname); ?></span></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <div class="col-md-12" id="en">
                                            ...
                                            <ol>
                                                ...
                                                <li>
                                                    ...
                                                    <ol>
                                                        <li><img src="<?php echo e(asset('img/QuizIcons/Logo1.png')); ?>" /> You have not visited the question yet.<br/><br/></li>
                                                        <li><img src="<?php echo e(asset('img/QuizIcons/Logo2.png')); ?>" /> You have not answered the question.<br/><br/></li>
                                                        <li><img src="<?php echo e(asset('img/QuizIcons/Logo3.png')); ?>" /> You have answered the question.<br/><br/></li>
                                                        <li><img src="<?php echo e(asset('img/QuizIcons/Logo4.png')); ?>" /> You have NOT answered the question, but have marked the question for review.<br/><br/></li>
                                                        <li><img src="<?php echo e(asset('img/QuizIcons/Logo5.png')); ?>" /> The question(s) "Answered and Marked for Review" will be considered for evalution.<br/><br/></li>
                                                    </ol>
                                                </li>
                                            ...
                                            <div class="col-md-4 col-md-offset-4 text-center">
                                                <form action="<?php echo e(route('student-testpaper')); ?>" method="POST">
                                                     <?php echo e(csrf_field()); ?>

                                                    <input id="id" type="hidden" name="id" >
                                                     <input id="plid" type="hidden" name="plid" >
       ...
       <div id="copyright">
                <div class="container">
                    <div class="col-md-12">
                        <p class="text-center">© 2019 Inspire Academy. | Designed by  <a target="https://deltatrek.in">Delta Trek</a> </p>

                    </div>
                </div>
            </div>
    </div>
   <script type="text/javascript" src="<?php echo e(asset('adminsa/js/jquery-2.1.1.min.js')); ?>"></script> 
   
   <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
    
   <script type="text/javascript">
       var id="<?php echo e($plink); ?>";
        var plid="<?php echo e($id); ?>";
