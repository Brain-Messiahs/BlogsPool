...
<div class="contact-address">  
  ...
  <div class="contact-form-section">
    ...
    <br>
    <h5 style="color: #e6bf55; align-self: center; font-size: 16px; ">Email us on <a href="mailto:support@deltatrek.in" style="color:#87CEFA;">support@deltatrek.in</a> or contact us by given below form.</h5>

    <br> 
    <h3 style="color: #FFFFFF" > Contact US </h3>
    <form method="post" action="<?php echo e(route('dmca_submit')); ?>" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" /><input type="hidden" name="utf8" value="✓" />
    <?php echo csrf_field(); ?>
