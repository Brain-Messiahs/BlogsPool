  ...
  <div class="limiter">
    ...
    <h4><b>Results</b>
     <div class="searchForm">
      <form action="<?php echo e(route('admin-student_result')); ?>" method="get">
...
<script type="text/javascript">
  $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('admin-student_result_page',['id'=>':id','s'=>':year','page'=>':page'])); ?>";
