    ...
    <div id="all">
       <header class="main-header">
                    ...
                    <div class="container">
                        <div class="navbar-header">
                           <a class="navbar-brand home">
                                <img src="<?php echo e(asset('img/logo.png')); ?>" alt="inspire logo" class="img-responsive">
                            </a>
                        </div>
        ...
        <div id="heading-breadcrumbs">
            ...
            <div id="copyright" class="nav">
                <div class="container">
                    <div class="col-md-12">
                      <p class="text-center">© 2019 Inspire Academy. | Designed by  <a href="https://deltatrek.in" target="_blank">Delta Trek</a> </p>
                    </div>
                </div>
            </div>
    </div>
