...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/mainresult_recycle_admin.css')); ?>">
  <div class="limiter">
    <div  class="title">
    <div class="searchBox">
    <h4><b>Results</b>
     <div class="searchForm">
      <form action="<?php echo e(route('admin-recycle_result')); ?>" method="get">
      ...
      <?php  $n = app('request')->input('page'); if($n>1||$n!=""){$no=$n*7-6;}else{$no=1;} ?>
       <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($user->active==0): ?>
                  ...
                  <td class="column7"> <a id="delete-button" data-toggle="modal" data-target="#delete" data-name="<?php echo e($user->name); ?>" data-id="<?php echo e($user->id); ?>">
              <i class="fa fa-recycle fa-2x" style="color: #30dd8a"></i></a></td> 
               <td class="column8"> <a id="p_delete-button" data-toggle="modal" data-target="#p_delete" data-name="<?php echo e($user->name); ?>" data-id="<?php echo e($user->id); ?>">
...
<script type="text/javascript">
  $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('admin-recycle_result_page',['s'=>':year','page'=>':page'])); ?>";
 ...
 $('#delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('admin-recycle_result_submit')); ?>',
    data: {
 ...
 $('#p_delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('admin-p_delete_result_submit')); ?>',
    data: {
      '_token': $('input[name=_token]').val(),
      'id': $('#p_delete-id').text(),
    },
