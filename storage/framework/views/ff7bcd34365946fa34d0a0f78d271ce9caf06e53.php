...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('account/table/css/util.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('account/table/css/mainprofile.css')); ?>">
   <div class="limiter">
...
<div class=" profile">
    <div class="profile-bottom">
      ...
      <div class="col-md-4 profile-bottom-img">
        <img src="<?php echo e(asset('account/images/'.Auth::user()->photo)); ?>" alt="">
      </div>
      <div class="col-md-8 profile-text">
        ...
        <tr><td>Subject : <?php echo e(Auth::user()->subject); ?></td></tr>
