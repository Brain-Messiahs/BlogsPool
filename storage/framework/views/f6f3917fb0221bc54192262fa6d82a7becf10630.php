						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">       
								...
								<select class="select-with-search form-control pmd-select2" name="category_id" id="category_id" required>
									...
									<option value="<?php echo e($c->id); ?>" data-name="<?php echo e($c->category_name); ?>"><?php echo e($c->category_name); ?></option>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<textarea class="form-control"  id="full_content" name="full_content"></textarea>
                  			...
                  			CKEDITOR.replace('full_content',{
                  				filebrowserUploadUrl: "<?php echo e(route('admin-ckeditor_upload', ['_token' => csrf_token() ])); ?>",
...
$("body").delegate(".select_image", "click", function() {     
     $('.socket_title').text('Select Image');
      var as = "<?php echo e(asset('')); ?>/notification_images/";
      ...
      $.get('<?php echo e(route('admin-upload_image_list')); ?>', function(data){
