...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  ...
  <div class="limiter">
    <div  class="title">
    <div class="searchBox">
    <h4><b>Upload Paper</b><?php if(Auth::user()->admin=='yes'): ?> <a href="<?php echo e(route('admin-adv_paper_upload')); ?>"> <i class="glyphicon glyphicon-2x glyphicon-upload" style="color: skyblue"></i></a><?php endif; ?>
    ...
    <div class="container-table100">
      ...
      <?php  $n = app('request')->input('page'); if($n>1||$n!=""){$no=$n*7-6;}else{$no=1;} ?>
       <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <td class="column9"><a href="<?php echo e(route('admin-advanced_paper_summary',['id'=>$user->id])); ?>"><i style="color: #fd6e70" class="glyphicon glyphicon-download"></i></a></td>
              ...
              <i class="glyphicon glyphicon-trash" style="color: #ff5c33"> </i> </a><?php if(Auth::user()->admin=='yes'): ?> <a  href="<?php echo e(route('admin-adv_paper_download',['id'=>$user->id])); ?>"> <i class="glyphicon glyphicon-download" style="color: #4CAF50"></i> </a><?php endif; ?></td>   
                          </tr>   
