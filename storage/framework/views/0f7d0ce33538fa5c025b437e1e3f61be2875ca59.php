...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<div class="section"> 
			...
			<form action="<?php echo e(route('admin-edit_category_submit')); ?>" method="post" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								...
								<input type="text" name="category_name" id="category_name" class="form-control" value="<?php echo e($dt->category_name); ?>" placeholder="" required>
							</div>
						</div>
