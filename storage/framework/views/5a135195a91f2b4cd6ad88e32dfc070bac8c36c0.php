...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  ...
  <div class="limiter">
    ...
    <div class="searchForm">
     <form action="<?php echo e(route('teacher-uploaded_paper')); ?>" method="get">
   ...
   <?php  $n = app('request')->input('page'); if($n>1||$n!=""){$no=$n*7-6;}else{$no=1;} ?>
       <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 ...
                 <td class="column5"><a style="color: #fff" href="<?php echo e(route('teacher-uploaded_paper_edit',['id'=>$user->id])); ?>"> <i class="glyphicon glyphicon-pencil" style="color:#ff9933"></a></td>
...
<script type="text/javascript">
   $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('teacher-uploaded_paper_page',['s'=>':year','page'=>':page'])); ?>";
 ...
 $('#delete_p').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('teacher-delete_link')); ?>',
    data: {
