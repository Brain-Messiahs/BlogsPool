...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  ...
  <div class="limiter">
    ...
    <div class="searchForm">
     <form action="<?php echo e(route('teacher-normal_paper')); ?>" method="get">
    ...
    <div class="container-table100">
      ...
      <?php  $n = app('request')->input('page'); if($n>1||$n!=""){$no=$n*7-6;}else{$no=1;} ?>
       <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td class="column3"><a style="color: #fff" class="btn btn-primary" href="<?php echo e(route('teacher-normal_paper_ques_upload',['id'=>$user->id])); ?>">Upload paper</a></td>
                  <td class="column4"><a style="color: #fff" class="btn btn-danger" href="<?php echo e(route('teacher-normal_paper_ans_upload',['id'=>$user->id])); ?>">Upload Ans.</a></td>
                 <td class="column5"><a style="color: #fff" class="btn btn-info" href="<?php echo e(route('teacher-normal_paper_update_result_page',['id'=>$user->id])); ?>">Update</a></td>
                 <td class="column6"><a style="color: #fff" class="btn btn-warning" href="<?php echo e(route('teacher-normal_paper_publish',['id'=>$user->id])); ?>">Publish</a></td>
              ...
              <i class="fa fa-eye" style="color: #5b84d7"></i></td>
               <td class="column9"><a href="<?php echo e(route('teacher-normal_paper_summary',['id'=>$user->id])); ?>"><i style="color: #fd6e70" class="glyphicon glyphicon-download"></i></a></td>
...
<script type="text/javascript">
   $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('teacher-normal_paper_page',['s'=>':year','page'=>':page'])); ?>";
 ...
 $('#delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('teacher-delete_nr_paper')); ?>',
    data: {
...
<script type="text/javascript">
   $(document).on('click', '#show-button', function() {
    ...
    loading.style.display='';
    var id=$(this).data('id');
    var img ="<?php echo e(route('teacher-nr_image',['id'=>':id'])); ?>";
