		...
		<div class="main-content-agile">
			...
			<div class="sub-main-w3">	
				<form action="#" method="post">
					<input placeholder="First Name" name="mail" type="text" required="">
					<span ><i  aria-hidden="true"></i></span>
					<input placeholder="Last Name" name="mail" type="text" required="">
					<span ><i  aria-hidden="true"></i></span>
					...
					<span ><i  aria-hidden="true"></i></span>
					<input  placeholder="Interested Profile" name="Company" type="text" required="">
					<span ><i  aria-hidden="true"></i></span>
					<input  placeholder="Link of C.V." name="Company" type="text" required="">
					<span ><i  aria-hidden="true"></i></span>
