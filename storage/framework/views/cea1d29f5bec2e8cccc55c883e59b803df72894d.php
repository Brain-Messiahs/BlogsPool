...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/mainresult_recycle.css')); ?>">
  <div class="limiter">
    <div  class="title">
    <div class="searchBox">
    <h4><b>Results</b>
     <div class="searchForm">
      <form action="<?php echo e(route('teacher-recycle_result')); ?>" method="get">
...
<script type="text/javascript">
  $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('teacher-recycle_result_page',['s'=>':year','page'=>':page'])); ?>";
 ...
 $('#delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('teacher-recycle_result_submit')); ?>',
    data: {
