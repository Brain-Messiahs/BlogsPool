...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/mainstudent_result.css')); ?>">
  <div class="limiter">
    <div  class="title">
    <div class="searchBox">
    <h4><b>Results</b>
     <div class="searchForm">
      <form action="<?php echo e(route('student-results')); ?>" method="get">
    ...
    <?php  $n = app('request')->input('page'); if($n>1||$n!=""){$no=$n*7-6;}else{$no=1;} ?>
       <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td class="column3"><strong><?php echo e($user->created_at); ?></strong></td>
                  <td class="column4"><strong><?php echo e($user->totalS); ?></strong></td>
                  <td class="column5"><strong><?php echo e($user->lefttime); ?> mins</strong></td>                     
                  <td class="column6"><?php if($user->rank!=''): ?>
                    <a>AIR <?php echo e($user->rank); ?></a><?php endif; ?></td>
                   
                  <td class="column7" style="padding: 5px 5px 5px 5px;cursor:pointer;" ><strong><a id="show-button" data-toggle="modal" data-target="#show" data-id="<?php echo e($user->id); ?>" data-name="<?php echo e($user->pname); ?>">RESULT</a></strong></td>
                  </tr>   
...
<script type="text/javascript">
    ...
    var img ="<?php echo e(route('student-results_page',['s'=>':year','page'=>':page'])); ?>";
   ...
   $(document).on('click', '#show-button', function() {
    ...
    loading.style.display='';
    var id=$(this).data('id');
    var img ="<?php echo e(route('student-resultshow',['id'=>':id'])); ?>";
