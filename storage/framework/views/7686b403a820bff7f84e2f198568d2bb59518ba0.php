...
4508<br /></p><mark></mark> 
  ...
  <div class="contact-form-section">
    ...
    <form method="post" action="<?php echo e(route('enquiry')); ?>" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" /><input type="hidden" name="utf8" value="✓" />
    <?php echo csrf_field(); ?>
