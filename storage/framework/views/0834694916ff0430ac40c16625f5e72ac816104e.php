...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/util.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('table/css/mainnormal_paper_list_recycle_admin.css')); ?>">
  <div class="limiter">
    <div  class="title">
    <div class="searchBox">
    <h4><b>Deleted Papers</b>
    <div class="searchForm">
     <form action="<?php echo e(route('admin-recycle_advanced_paper')); ?>" method="get">
       ...
       <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($user->active == 0): ?>
              ...
              <i class="fa fa-recycle fa-2x" style="color: #30dd8a"></i></a></td> 
               <td class="column8"> <a id="p_delete-button" data-toggle="modal" data-target="#p_delete" data-name="<?php echo e($user->pname); ?>" data-id="<?php echo e($user->id); ?>">
...
<script type="text/javascript">
   $(document).on('click','.pagination a', function(e){
    ...
    var img ="<?php echo e(route('admin-recycle_advanced_paper_page',['s'=>':year','page'=>':page'])); ?>";
 ...
 $('#delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('admin-recycle_advanced_paper_submit')); ?>',
    data: {
...
$(document).on('click', '#p_delete-button', function() {
 ...
 $('#p_delete-student').click(function() {
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo e(route('admin-p_delete_advanced_paper_submit')); ?>',
    data: {
      '_token': $('input[name=_token]').val(),
      'id': $('#p_delete-id').text(),
    },
