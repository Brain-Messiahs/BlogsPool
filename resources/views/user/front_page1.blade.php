...
<div class="container">
				...
				<div class="wrapper">
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Vegetables']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
					...
					<div class="product-sec1 product-sec2" id="nuts_block">
						...
						<div class="col-xs-5 bg-right-nut">
							<img src="{{asset('user_css/images/nut1.png')}}" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
					<!-- //second section (nuts special) -->
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Dried Fruits & Nuts']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
	...
	<div class="featured-section" id="projects">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l"><a href="{{ route('products',['category'=>'Offers']) }}">Special Offers
						...
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								...
								<div class="w3l-pricehkj">
									<h6>₹{{$product->product->admin_selling_price}}</h6>
									<p>Save ₹{{$product->product->admin_mrp - $product->product->admin_selling_price}}</p>
								</div>
								<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
									<input type="submit"  name="submit" data-id="{{$product->product->id}}" value="Add to cart" class="button add_cart" /> 
								</div>
	...
	<!-- //special offers -->
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Fruits']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Ghasitaram Sweets']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Grocery']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Bread & Bakery']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Biscuits & Cookies']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Snacks & Beverages']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
					...
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Soft Drinks']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
					...
					<!------------------------------------Personal_Care ------------------------->
					<?php $no=0 ?>
					@foreach ($Personal_Care as $product)
					@if($no==0)
					<div class="product-sec1" style="padding-bottom: 5px">
						...
						<hr style="margin: 3px;">
						 <div><h4 style="color:#000;margin-left:40%; padding:7px;">
								<a href="{{ route('products',['category'=>'Personal Care']) }}" style="color:tomato;"><h4>More...</h4></a>
							</h4>
							</div>
							@endif
					</div>
    ...
    var link ='{{ route('products',['category'=>'Dried Fruits & Nuts']) }}';
