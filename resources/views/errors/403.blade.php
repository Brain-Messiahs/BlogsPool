...
<body>
    <div class="inner-block" style="margin-top: 7%">
    <div class="error-404">     
        <div class="error-page-left">
            <img src="{{asset('wp-content/image/404.jpg')}}" width="360">
        </div>
    ...
    <div class="error center-block">
            ...
            <a href="https://contrivanceonline.in" style="text-decoration: none;">Go Login Page</a>
        </div>
</div>
<style type="text/css">
    .error h2 {
